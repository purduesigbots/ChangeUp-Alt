...
void red() {
	...
	// intake 1 red
	macro::intake();
	odom::holoThru({22, 4}, 88.4, 40, 100);

	// move to center red
	odom::holoThru({34.5, -4}, 0, 100, 150);
