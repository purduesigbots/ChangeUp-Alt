...
void red() {
	...
	*/
	...
	odom::holoThru({-84, -60}, 135, 100, 100);
	...
	chassis::fast(-8);
	odom::holo({24, 12}, 180, 100, 100);
	macro::intake();
	odom::holoThru({24, 0}, 270, 40, 150);

	// move to line ball
	odom::holoThru({36, 12}, 0, 100, 100);

	// intake line ball
	vision::alignRed();

	// align with side goal
	odom::holo({60, 12}, -90, 100, 100);
